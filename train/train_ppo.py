...
try:
    ...
    print("Warning: shimmy not installed; install via 'pip install shimmy>=2.0' if you encounter env errors", file=sys.stderr)
...
if __name__=='__main__':
    ...
    parser.add_argument('--data-files', nargs='+', required=True, help='CSV files for training')
    parser.add_argument('--model-out', default='ppo_trend.zip', help='Output model file')
    parser.add_argument('--stats-out', default='vecnorm_trend.pkl', help='Output normalization stats')
